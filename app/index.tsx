    ...
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.header}>
          <Text style={[styles.title, { color: colors.text }]}>Cardsssss</Text>
        ...
        >
          ...
          <View
            style={[styles.moduleFooter, { borderTopColor: colors.border }]}
          >
            <Pressable
              onPress={() => router.push("/ielts")}
              style={({ pressed }) => [
            ...
            >
              <Text style={[styles.footerBtnLabel, { color: colors.text }]}>
                Browse
              </Text>
            </Pressable>
